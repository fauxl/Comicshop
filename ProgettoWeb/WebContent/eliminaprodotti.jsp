...
<head>
<meta charset="utf-8" />
<title>Elimina o modifica Prodotti - ComicShop.it</title>
...
<body>
	<div class="container">
		...
		<ul class="breadcrumb">
				...
				<li class="active">Elimina o modifica Prodotti</li>
			</ul>
			<h1>Elimina o modifica Prodotti</h1>
			<hr>
			<br><br>
			...
			<h2>Elimina o modifica Fumetti</h2>
			<hr>
			...
			<h2>Elimina o modifica Gadget</h2>
			<hr>
