...
<head>
<meta charset="utf-8" />
<title>La tua lista dei desideri - ComicShop.it</title>
			...
			%>
				<%
					...
					%>
						...
						<td><a href="wishes?action=delete&id=<%=bean.getcode()%>" onclick="updatewishes()">Elimina</a></td>
							
			<%  if (bean.getavailability()>0){ %>
				<td><a href ="carrello?action=read&id=<%=bean.getcode()%>" onclick="updatecart()">Aggiungi</a>
