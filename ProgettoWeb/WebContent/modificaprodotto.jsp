...
<head>
<meta charset="utf-8" />
<title>Modifica prodotto - ComicShop.it</title>
			...
			<form action="modify" method="post" enctype="multipart/form-data">
				...
				<div id="table">
					<div id="row">
						...
						<div id="dati1">
						<p>Codice:</p>
						<input name="code" type="text" maxlength="30" value="<%=object.getcode()%>" readonly="">
				
				
							<p>Titolo:</p>
							<input name="title" type="text" maxlength="30" required value="<%=object.gettitle()%>">
							
							
							<p>Genere:</p>
							<input name="gender" type="text" maxlength="30" required value="<%=object.getgender()%>">
							
								<p>Disponibilita:</p>
							<input name="availability" type="text" maxlength="30" required value="<%=object.getavailability()%>">
						...
						<div id="dati2">
							<p>Costo:</p>
							<input name="price" type="text" maxlength="30" required value="<%=object.getprice()%>">

							<p>Scrittore:</p>
							<input name="writer" type="text" maxlength="30" required value="<%=object.getwriter()%>" >

							<p>Disegantore:</p>
							<input name="drawer" type="text" maxlength="30" required value="<%=object.getdrawer()%>">
						...
						<div id="dati3">
							...
							<p>Publisher:</p>
							<input name="publisher" type="text" maxlength="30" required value="<%=object.getpublisher()%>"> <br>
							
							<p>Trama:</p>
						<textarea name="plot" rows="10" cols="18" required ><%=object.getplot()%></textarea>
						...
						<div id="dati4">
							...
							<p>Tipo:</p>
							<input name="type" type="text" maxlength="30" required value="<%=object.gettype()%>"> 
							<br>
							<p>Numero:</p>
							<input name="number" type="text" maxlength="30" required value="<%=object.getnumber()%>"> 
			...
			<form action="modify" method="post" enctype="multipart/form-data">
				...
				<div id="table">
					<div id="row">
						...
						<div id="dati2">
							<p>Peso:</p>
							<input name="weight" type="text" maxlength="30" required value="<%=oggetto.getweight()%>">
